---
name: de-ai-slop-ui
description: Finds and removes the 30 visual and copy tells that make a site instantly recognizable as AI-generated - purple-on-black palettes, harsh gradients, glassmorphism, glow blobs, sparkle and default Lucide icons, Inter/Geist/Grotesk, shadows and hovers on everything, huge border radius, three-card feature grids, bento layouts, three-tier pricing tables, checkmark bullets, "not just X, it's Y" copy, em dashes, emoji as icons, invented testimonials, no real product screenshot, neon pastels, missing terms and privacy pages. Replaces each with a deliberate alternative rather than just deleting it. Use whenever the user says their site looks AI-made, generic, templated or soulless; wants a design to look human, custom or less like v0/Lovable built it; says "sitem yapay zeka yapımı duruyor", "tasarım jenerik", "şablon gibi görünüyor", "insan eli değmiş gibi olsun"; and proactively before shipping any AI-generated landing page or app UI. Not for SEO, meta tags or crawlability; use vibecode-tech-audit for that.
---
