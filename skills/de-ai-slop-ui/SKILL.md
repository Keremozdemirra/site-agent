---
name: de-ai-slop-ui
description: Finds and removes the 30 visual and copy tells that make a site instantly recognisable as AI-generated — purple-on-black, glassmorphism, glow blobs, default Lucide icons, Inter/Geist, shadows and hovers on everything, three-card grids, bento layouts, checkmark bullets, "not just X, it's Y" copy, emoji as icons, invented testimonials, no real product screenshot. Replaces each with a deliberate alternative rather than just deleting it. Use when a site looks AI-made, generic, templated or soulless, or should look like a human built it rather than v0 or Lovable — "sitem yapay zeka yapimi duruyor", "tasarim jenerik", "sablon gibi gorunuyor" — and before shipping any AI-generated landing page. Not for SEO or crawlability; use vibecode-tech-audit.
---
